...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
        ...
        <div class="m-subheader floatright padding0">

            <a href="#collapseFilter" id="collapseFilter1"
               class="btn btn-outline-primary m-btn m-btn--pill m-btn--outline-2x margin-right-20"
               data-toggle="collapse"><i class="la la-filter"></i> Vis filter</a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-tabs  m-tabs-line m-tabs-line--2x m-tabs-line--danger" role="tablist">
                    ...
                    <li class="nav-item m-tabs__item">
                        <a href="/admin/clients/potensiell" class="nav-link m-tabs__link">Potensielle interessenter <sup
                                    class="orange">432</sup></a>
                    </li>
                    <li class="nav-item m-tabs__item">
                        <a href="/admin/clients/markedsforing" class="nav-link m-tabs__link">Digital markedsføring</a>
                    </li>
                    <li class="nav-item m-tabs__item">
                        <a href="/admin/clients/solgte" class="nav-link m-tabs__link active">Solgte i nærheten <sup
                                    class="orange">432</sup></a>
                    </li>
                </ul>
            </div>
