...
$departments = $user->department->partner->activeDepartments;
$model->dep_names = ArrayHelper::map($model->isNewRecord ? $departments : $model->departments, "short_name", "short_name");
...
<?= $form->field($model, "dep_names")->widget(Select2::class, [
    'model' => $model,
    'attribute' => 'dep_names',
    'value' => $model->dep_names,
    'data' => ArrayHelper::map($departments, "short_name", "short_name"),
    'maintainOrder' => true,
    'options' => [
        'multiple' => true,
    ],
