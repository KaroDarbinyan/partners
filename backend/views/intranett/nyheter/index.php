...
<div class="block-nyheter m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-content">
        <button type="button" class="btn video-btn mb-4" data-toggle="modal"
                data-src="https://player.vimeo.com/video/400561123" data-target="#myModalVideo">
                            ...
                            <div class="m-portlet__head-caption">
                                <?php if (!$user->hasRole('broker')): ?>
                                    <div class="m-portlet__head-action">
                                        <a href="<?= UrlExtended::to(['nyheter-update', 'id' => $news->id]) ?>"
                                           class="btn btn-sm m-btn--pill btn-secondary">
                                            Rediger
                                        </a>
                                        <a href="#"
                                           data-action="<?= UrlExtended::to(['nyheter-delete', 'id' => $news->id]) ?>"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-widget19">
                                <div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides">
                                    <img class="news-image" src="<?= $img ?>" alt="<?= $news->name ?>"
                                ...
                                <div class="m-widget19__content">
                                    ...
                                    <div class="m-widget19__body">
                                        <h4 class="m-widget19__title m--font-light" style="text-align: left;"
                                            onclick="window.open('<?= $url ?>', '_self')"><?= $news->name ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
