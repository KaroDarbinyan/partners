...
<div class="m-portlet__body" style="padding: 0;">
    ...
    <div class="row">
        <div class="col-md-6">
            <div id="map" style="height:calc(100vh - 165px); border-bottom-left-radius: 1rem;"></div>
        </div>
        <div class="col-md-6" style="padding-right: 30px; padding-top: 15px;">

            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--danger additional" role="tablist">
                <li class="nav-item m-tabs__item ">
                    <a class="nav-link m-tabs__link active" data-toggle="tab" role="tab" href="#m_tabs_1_1">
                        Bilder
                    </a>
                </li>
                <li class="nav-item m-tabs__item">
                    <a class="nav-link m-tabs__link" data-toggle="tab" role="tab" href="#m_tabs_1_2">
                        Detaljer
                    </a>
                </li>
                <li class="nav-item m-tabs__item">
                    <a class="nav-link m-tabs__link" data-toggle="tab" role="tab" href="#m_tabs_1_3">
                        Statistikk
                    </a>
                </li>
                <li class="nav-item m-tabs__item">
                    <a class="nav-link m-tabs__link" data-toggle="tab" role="tab" href="#m_tabs_1_4">
                        Nabolagsprofil
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="m_tabs_1_2" role="tabpanel">
                    ...
                    <div class="m-scrollable" data-scrollable="true" data-height="550" data-scrollbar-shown="true">
                        <span class="schala-status" style="margin: 0px 0 0 0;"><span class="m-badge m-badge-xxl m-badge--dot schala-status-kontaktet"></span><em>kontaktet</em></span>
                        <table class="table m-table m-table--head-no-border table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Hausmannsgaten 19 Borettslag (Reg=2011.03.14 av SMO) / 967155799</td>
                                </tr>
                                <tr>
                ...
                <div class="tab-pane" id="m_tabs_1_4" role="tabpanel">
                    ...
                    <div>
                        <table class="table m-table m-table--head-no-border table-hover table-cell-center" id="m_table_1">
                            <thead>
                                <tr>
                                    <th>Type</th>
                                    <th>Navn</th>
