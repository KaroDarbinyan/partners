...
$this->registerJsFile('@web/js/datatables/oppdrag.js');
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="m-portlet m-portlet--mobile m-portlet--body-progress-">
                    <button type="button" class="btn video-btn mt-4 ml-4" data-toggle="modal" data-src="https://player.vimeo.com/video/400562845" data-target="#myModalVideo">
                        ...
                        <form id="data-table-filter" class="mb-3" method="post" style="display: none">
                            <div class="form-row align-items-center">
                                <div class="col-sm mb-3">
                                    <select class="form-control form-control-sm form-filter" data-col-index="1">
                                        <option value="">Alle statuser</option>
                                        <option value="-1">Solgt</option>
                                        <option value="0">Til salgs</option>
                                        <option value="1">Signert</option>
                                    </select>
                                </div>
                                <div class="col-sm mb-3">
