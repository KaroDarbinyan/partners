window.addEventListener('load', function () {
    $('#data-table').DataTable({
        ...
        columnDefs: [
            {targets: [0, 3, 4, 5, 6, 7, 9, 10, 11, 13, 14, 15], searchable: false, visible: false},
            {
                targets: 1,
                render: function (data, type, row, meta) {
                    return '<span class="schala-status"><span class="m-badge m-badge--dot schala-type-befaring"></span><em>Befaring</em></span>';
                }
            },
            {
                targets: 2,
