...
/**
 * Class m190410_072145_RECREATE_property_table_with_all_data
 */
class m190410_072145_RECREATE_property_table_with_all_data extends Migration
{
    ...
    private $fileName = 'frontend/web/requests/data.txt';
    ...
    public function safeUp(){
        ...
        $data = Yii::$app->WebmeglerApiHelper->xmlObjToAssocArray($data);
        $this->data = $data['eneiendom'];
        file_put_contents('frontend/web/requests/data.json', json_encode($data));
