...
/**
 * Class m190724_071509_CHANGE_utlopsdato_column_type_to_int_11
 */
class m190724_071509_CHANGE_utlopsdato_column_type_to_int_11 extends Migration
{
    private $tableName = "property_details";
    private $columnName = "utlopsdato";
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $props = (new \yii\db\Query())
            ...
            ->orWhere(['not', [$this->columnName => NULL],])
            ->all();
