...
/**
 * Class m200413_175543_ADD_COLUMN_eiendomsverdi_to_departments
 */
class m200413_175543_ADD_COLUMN_eiendomsverdi_to_departments extends Migration
{
    private $tableName = "department";
    private function getColumns(){
        return [
            "eiendomsverdi"=> $this->string(32),
        ];
    }
